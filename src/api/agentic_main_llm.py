...
from src.agents.langgraph_llm_orchestrator import LangGraphDemandDecisionOrchestrator
from src.api.agentic_llm_schema import PredictionRequest, PredictionResponse
...
def predict(request: PredictionRequest):
    ...
    return PredictionResponse(
        ...
        explanation={
            "mode": decision_result.get("llm_mode", "fallback"),
            ...
            "next_best_actions": decision_result["next_best_actions"],
        },
        system={
            "model_name": "Agentic LightGBM Demand Forecasting System",
            "model_version": "1.0.0",
            "workflow": decision_result.get("workflow", "LangGraph + LLM Reasoning"),
        },
    )
